// admin-change-password.js - Admin panel change password form submission
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (form) {
        form.addEventListener('submit', function (e) {
            ...
            // Submit the form
            submitAdminChangePasswordForm(form, submitButton);
        });
    }
});

function submitAdminChangePasswordForm(form, submitButton) {
    const formData = new FormData(form);
    
    fetch('/Admin/User/ChangePassword', {
        method: 'POST',
        headers: {
